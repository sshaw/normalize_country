...
* {Carmen}[https://github.com/jim/carmen]: Lookup countries and their states/providences by ISO name/code 
* {i18n_data}[https://github.com/grosser/i18n_data]: ISO country names in different languages, includes alpha codes
* {ModelUN}[https://github.com/uhhuhyeah/model_un]: Similar to this gem but with less naming support, it does include US states

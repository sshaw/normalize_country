...
If you want to extend a list of default countries you should use method +extend_countries+ or its alias +add_counties+:

 NormalizeCountry.extend_countries(:alpha2 => "SU", :iso_name => "Soviet Union", :short => "USSR")
 NormalizeCountry.extend_countries({ :alpha2 => "YU", :iso_name => "Yugoslavia" }, { :alpha2 => "CS", :iso_name => "Czechoslovakia" })
 NormalizeCountry.add_countries([{ :alpha2 => "DD", :iso_name => "German Democratic Republic", :short => "USSR" }, { :alpha2 => "ZR", :iso_name => "Zaire" }])
 NormalizeCountry.add_countries("/path/to/yaml/config")

The standard list can also be overridden:

 NormalizeCountry.extend_countries(:alpha2 => "US", :official => "United States of North America")
